...
public class EntrenamientoYNOLD {
    ...
    public static void main(String args[]){
        ...
        RNEvalutiva n =  new RNEvalutiva("YNOLD", 32, 16, 1000, 10, 0.01, 8, 8);
        ...
        File f_YN = new File(Util.getPropCfgRNSx("PATH_YN"));
