...
public class EntrenamientoYN {
    ...
    public static void main(String args[]){
        RNEvalutiva n =  new RNEvalutiva("YN", 2500, 4, new int[]{1000,500,100,50}, 1, 5000, 2000, 0.01);
        double [][]entradas;
        double [][]salidas;
        int numEntradas;
        int aux = 0;
        ...
        File[] imgs_YN = f_YN.listFiles();
        numEntradas = imgs_YN.length;
        ...
        while(indexEntradas < numEntradas){
            try {
                    ...
                    imgAux = ImageIO.read(imgs_YN[indexEntradas]);
