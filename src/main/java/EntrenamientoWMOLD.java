 ...
 * @author Bribiesca
 */
public class EntrenamientoWMOLD {
    public static void main(String args[]){
        ...
        RNEvalutiva n =  new RNEvalutiva("WMOLD", 32, 16, 1000, 1, 0.01, 8, 8);
        ...
        File f_WM = new File(Util.getPropCfgRNSx("PATH_WM"));
        ...
        if(!f_OLD.exists()){
            System.err.println("Directorio erroneo de YN");
            return;
        }
        ...
        n.guardarRN("C:\\Users\\Bribiesca\\Desktop");
